...
#initial function for the calling of the trackbar, only for reference
def hello(x):
	pass
...
while(True):
	...
	#Kernel to be used for dilation - not required if you have a high-quality webcam
